...
def configure_document(document: Document) -> None:
    ...
    footer.text = "Prepared by Harsha S | 03 August 2026"
...
def build_report(output_path: Path) -> None:
    ...
    add_body(document, "Validation timestamp: 03 August 2026, 23:58 IST. These values were refreshed from the live Render service immediately before this report was generated.")
    ...
    add_heading(document, "14. Manager-Ready Conclusion")
