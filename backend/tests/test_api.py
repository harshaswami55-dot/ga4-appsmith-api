...
class FakeGA4:
    ...
    settings = SimpleNamespace(
        ...
        event_tutorial_skip_attempt="tutorial_skip_attempt",
        event_level_start="level_start",
        event_level_complete="level_complete",
        event_app_remove="app_remove",
        event_hint_highlighted="hint_button_highlighted",
        event_hint_clicked="hint_button_clicked",
        event_hint_used="hint_used_successfully",
        level_dimension="customEvent:level_number",
        tutorial_step_dimension="",
        action_type_dimension="customEvent:action_type",
        action_add_row_value="add_row",
        level_time_metric="",
